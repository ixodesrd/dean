        ...
        $(function () {
            $("#grid").shieldGrid({
                dataSource: {
                    ...
                    schema: {
                        fields: {
                            ...
                            faculty: { path: "faculty", type: String },
                        }
                    }
                },
                sorting: true,
                ...
                columns: [
                    ...
                    { field: "faculty", title: "Факультет", width: 200 },
                ...
                toolbar: [
                    {
                        buttons: [
                            { commandName: "insert", caption: "Add dean" }
                        ],
                        position: "top"
                    },
                    {
