        ...
        $(function () {
            $("#grid").shieldGrid({
                dataSource: {
                    ...
                    schema: {
                        fields: {
                            ...
                            rating: { path: "rating", type: String },
                        }
                    }
                },
                sorting: true,
                ...
                columns: [
                    ...
                    { field: "group", title: "group", width: 200 },
                    { field: "age", title: "Возраст", width: 120 },
                    { field: "isMale", title: "Пол", width: 100 },
                    { field: "rating", title: "Рейтин", format: "{0:c}", width: 80 },
                    {
                        width: 140,
                        title: " ",
                        buttons: [
